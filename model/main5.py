...
if args.network == "fusionnet":
	...
	generator = nn.DataParallel(FusionGenerator(7,1,32),device_ids=None).cuda()
	...
	#generator = nn.DataParallel(UnetGenerator(9,1,64),device_ids=[i for i in range(args.num_gpu)]).cuda()
        generator = nn.DataParallel(UnetGenerator(7,1,32),device_ids=None).cuda()


"""
# load pretrained model
try:
    generator = torch.load('./result/trained/64_{}_{}.pkl'.format(args.network,'099'))
    print("\n--------model restored--------\n")
except:
    print("\n--------model not restored--------\n")
    pass
...
# training
file = open('./result/res_error/{:03d}_{}_loss'.format(args.number,args.network), 'w')
logger = Logger('./result/logs')

#tensor_train_input_dir = "/home/yeonjee/lv_challenge/data/dataset_tensor/dataset/p/train/"
tensor_train_input_dir = "/home/powergkrry/lv_challenge/data/dataset/dataset14_tensor/i/train/"
#tensor_train_output_dir = "/home/yeonjee/lv_challenge/data/dataset_tensor/dataset/p/train_output/"
tensor_train_output_dir = "/home/powergkrry/lv_challenge/data/dataset/dataset14_tensor/i/train_output/"
#tensor_test_input_dir = "/home/yeonjee/lv_challenge/data/dataset_tensor/dataset/p/test/"
tensor_test_input_dir = "/home/powergkrry/lv_challenge/data/dataset/dataset14_tensor/i/test/"
#tensor_test_output_dir = "/home/yeonjee/lv_challenge/data/dataset_tensor/dataset/p/test_output/"
tensor_test_output_dir = "/home/powergkrry/lv_challenge/data/dataset/dataset14_tensor/i/test_output/"
...
for i in range(epoch):
    ...
    torch.save(generator,'./result/trained/{:03d}_{}_{:03d}.pkl'.format(args.number,args.network,i))
    #scheduler.step()
