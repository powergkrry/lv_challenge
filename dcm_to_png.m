...
for i = 3:length(dir_list) %1 is ., 2 is .., 3 is content
    ...
    path_image_i = strcat('/hoem04/powergkrry/lv_challenge/data/ioriginal_png/', num2str(i-2), '.png'); %png image path to save
...
for i = 3:length(dir_list) %1 is ., 2 is .., 3 is content
    ...
    path_image_o = strcat('/hoem04/powergkrry/lv_challenge/data/ooriginal_png/', num2str(i-2), '.png'); %png image path to save
...
for i = 3:length(dir_list) %1 is ., 2 is .., 3 is content
    ...
    path_image_p = strcat('/hoem04/powergkrry/lv_challenge/data/poriginal_png/', num2str(image_order), '.png'); %png image path to save
